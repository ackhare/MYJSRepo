...
//Then we set the constructor of this new object to point to the childObject.​
    ...
    // immediately following this code block.​
     //    Essentially, we are copying all the properties and methods from the parentObject
     // to the childObject, but we are using the copyOfParent as an intermediary for the copy.
     // And because the childObject prototype was overwritten during the copy, we manually set
     // the copyOfParent constructor to the childObject. Then we set the childObject prototype
     // to the copyOfParent so that the childObject inherits from the parentObject.
...
function Question(theQuestion, theChoices, theCorrectAnswer) {
    ...
    // Constant variable: available to all instances through the instance method below.
    // This is also a private property.​
...
function MultipleChoiceQuestion(theQuestion, theChoices, theCorrectAnswer){
    ...
    // here inside the MultipleChoiceQuestion constructor,
    // we have to explicitly call the Question constructor​
